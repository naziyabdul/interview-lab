          ...
          {!timerStarted ? (
            <>
              ...
              <button
                ...
                style={{padding:'8px 20px',backgroundColor:'#7c3aed',color:'white',border:'none',borderRadius:'8px',cursor:'pointer'}}>
                Start Timer
              </button>
            </>
          ) : (
            <Timer
              ...
              onTimeUp={() => navigate('/feedback', { state: { code, question, language } })}
            />
          )}
          <button
            onClick={() => navigate('/mode')}
